...
location_enemies = {
    ...
    DARK_FOREST: [
        ...
        Enemy("Witch of Skulls", 10, 5, "dark_witch.jpg",
              random.randint(30, 30), 1500, bloodstone=1),
    ],
    ...
    HAUNTED_RUIN: [
        ...
        Enemy("Wraith Lord", 120, 18, "wraith_lord.jpg",
              random.randint(40, 40), 2000, bloodstone=1)
    ],
    ...
    ENCHANTED_FOREST: [
        ...
        Enemy("Lady of the Forests", 120, 18, "fairy_druid.jpg",
              random.randint(50, 50), 3000, bloodstone=1)
    ],
    ...
    FROSTFANG_PEAK: [
        ...
        Enemy("Frost Dragon", 130, 20, "frost_dragon.jpg",
              random.randint(70, 70), 4000, bloodstone=1)
    ],
    ...
    SUNKEN_TEMPLE: [
        ...
        Enemy("Deepsea Horror", 130, 20, "deepsea_horror.jpg",
              random.randint(100, 100), 5000, bloodstone=1)
    ],

    CRIMSON_CASTLE: [
        Enemy("Sangromancer", 110, 16, "sangromancer.jpg",
              random.randint(60, 65), 3700),
