...
druid_rect = druid_img.get_rect(center=(SCREEN_WIDTH // 2 + 45, SCREEN_HEIGHT // 2))
...
cryo_rect = cryo_img.get_rect(center=(SCREEN_WIDTH // 2 + 45, SCREEN_HEIGHT // 2))
...
bard_rect = cryo_img.get_rect(center=(SCREEN_WIDTH // 2 + 45, SCREEN_HEIGHT // 2))
